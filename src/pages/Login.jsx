      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Library & Asset Management</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="admin@library.test"
              />
            </div>
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className="text-xs text-gray-600 space-y-1">
              <p>Admin: admin@library.test / password</p>
              <p>Staff: staff1@library.test / password</p>
              <p>Member: member1@library.test / password</p>
            </div>
          </div>
        </div>
      </div>
